...
const Navbar = ({ isAuthenticated = false }) => {
  ...
  return (
  <nav className="glass border-b border-sage-200/60">{/* Navbar visible for font testing */}
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/dashboard" className="flex items-center space-x-2 group">
              ...
              <span className="text-2xl font-pacifico text-black transition-colors">MindWatch</span>
            </Link>
          </div>
          ...
          {isAuthenticated && (
            <div className="flex items-center space-x-4">
              ...
              <button className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-black hover:bg-gray-100/30" aria-label="Open menu">
